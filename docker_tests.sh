...
# Compile kserverd
make BUILD_LOCAL=True CONFIG=config/config_local.yaml clean all
make BUILD_LOCAL=True CONFIG=config/config_armel.yaml clean all
make BUILD_LOCAL=True CONFIG=config/config_armhf.yaml clean all
